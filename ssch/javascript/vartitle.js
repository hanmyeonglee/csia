...
const dises =
  ...
  const diags = "보건실휴식,타세놀,모드코,모드콜,모드코프,쎄로테정,지르텍,리놀,화이투벤큐노즈,화이투벤큐,부스코판>플러스,부루펜,아나프>록스정,탁센,그날엔,이지엔식스이브,이지엔식스,탁센레이디,정로환,베아제,훼스탈,마로이 신,나조린,아이투오,케프란,신폴에이,스타빅,알마겔,포타겔,coban,후시메드,밴드,에어파스,멸균안대,생리대,자가키트,거즈,탄력붕대,바세린,오라메디,페리덱스,알보칠,>아프니벤큐,쎄레스톤지,제올라,버물리,아즈렌,하이맘번,드레싱밴드,생리식염수,애니클린,리도맥스,타세놀콜드,호올스,포도당캔디,애드빌,비코그린,베나치오,맥시롱,쌍화탕,콜대원,백초,써버쿨,타이레>놀우먼,반창고,타벡스겔,아이스팩,핫팩,병원진료확인증,씨즈날 정,소독,파스,박트리안,생리식염수,케토핀프리,신폴에이,소렉신,생리조퇴".split(",");
